...
--
-- Host: 82.25.108.74    Database: crmpro_v2_whatsapp_test
-- ------------------------------------------------------
...
CREATE TABLE `whatsapp_inbound_messages` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `provider` varchar(30) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'INTERAKT',
  ...
  `from_phone` varchar(25) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `normalized_number` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `message_text` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `message_type` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `event_type` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `button_text` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `button_payload` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `received_at` datetime DEFAULT NULL,
  `raw_payload` json DEFAULT NULL,
  `lead_type` enum('DIRECT','BOT') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `lead_table` enum('direct_leads','new_leads','working_sheet') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `lead_id` int DEFAULT NULL,
  `telecaller_id` int DEFAULT NULL,
  `processed_status` enum('PENDING','PROCESSED','FAILED','IGNORED') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'PENDING',
  ...
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  UNIQUE KEY `uniq_wa_inbound_event_id` (`event_id`),
  UNIQUE KEY `uniq_wa_inbound_message_id` (`whatsapp_message_id`),
  ...
  KEY `idx_wa_inbound_lead` (`lead_type`,`lead_table`,`lead_id`),
  KEY `idx_wa_inbound_event_type` (`event_type`)
...
CREATE TABLE `whatsapp_message_logs` (
  ...
  `provider` varchar(30) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'INTERAKT',
  `event_key` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `whatsapp_message_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `lead_type` enum('BOT','DIRECT') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `lead_table` enum('new_leads','working_sheet','direct_leads') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `lead_id` int DEFAULT NULL,
  `telecaller_id` int DEFAULT NULL,
  `phone_number` varchar(25) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `normalized_number` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `template_key` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `template_name` varchar(150) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `message_type` enum('TEMPLATE','SESSION','INBOUND') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `message_text` text COLLATE utf8mb4_unicode_ci,
  `status` enum('PENDING','SENT','DELIVERED','READ','FAILED','SKIPPED') COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  KEY `idx_wa_log_event_key` (`event_key`),
  KEY `idx_wa_log_message_id` (`whatsapp_message_id`),
  KEY `idx_wa_log_phone` (`normalized_number`)
...
CREATE TABLE `whatsapp_message_queue` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `event_key` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `lead_type` enum('BOT','DIRECT') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `lead_table` enum('new_leads','working_sheet','direct_leads') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `lead_id` int NOT NULL,
  `telecaller_id` int DEFAULT NULL,
  ...
  `normalized_number` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `trigger_type` enum('BOT_LEAD_ENTERED_DASHBOARD','BOT_LEAD_ASSIGNED','DIRECT_LEAD_CREATED','DIRECT_LEAD_ASSIGNED','DIRECT_CUSTOMER_INTERESTED','DIRECT_RM_SESSION_MESSAGE','STATUS_CHANGED','NOT_INTERESTED_FOLLOWUP','MANUAL_TEST') COLLATE utf8mb4_unicode_ci NOT NULL,
  `old_status` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `template_language` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'en',
  `template_params` json DEFAULT NULL,
  `message_type` enum('TEMPLATE','SESSION') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'TEMPLATE',
  `message_text` text COLLATE utf8mb4_unicode_ci,
  ...
  UNIQUE KEY `uniq_wa_queue_event_key` (`event_key`),
...
CREATE TABLE `whatsapp_settings` (
  ...
  `provider` enum('INTERAKT','META_CLOUD') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'INTERAKT',
  `interakt_api_base_url` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `interakt_webhook_url` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `direct_leads_enabled` tinyint(1) NOT NULL DEFAULT '0',
  `bot_leads_enabled` tinyint(1) NOT NULL DEFAULT '0',
  `session_messages_enabled` tinyint(1) NOT NULL DEFAULT '1',
  `phone_number_id` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `default_country_code` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '91',
...
CREATE TABLE `whatsapp_templates` (
  ...
  `template_key` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `template_name` varchar(150) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `language_code` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'en',
  `trigger_type` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `status_match` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
-- Dump completed on 2026-07-14  4:08:48
