...
const STATUS_OPTIONS = [
  "Ringing", "Call Back", "Info Given", "Wrong No", "Int Angel", "Think&LMK", "Not Int", "RdyKYC"
];
  ...
  if (isError) {
    return (
      <div className="flex flex-col items-center justify-center h-full min-h-[400px] text-slate-500">
        ...
        <p className="text-lg font-medium text-slate-900 dark:text-white">Failed to load Bot Pool status.</p>
        <button 
          onClick={() => refetch()} 
