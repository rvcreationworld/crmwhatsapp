...
exports.getSettings = async (req, res) => {
  try {
    ...
    rows.forEach(row => {
      // Parse numeric keys
      if (['minimum_call_duration_for_status_update', 'minimum_call_duration_for_rdykyc_status', 'sync_interval', 'minimum_call_duration_status_1', 'minimum_call_duration_rdykyc'].includes(row.setting_key)) {
